...
nx   =  30;                 % Number of grid blocks along x-direction
ny   =  15;                 % Number of grid blocks along y-direction
...
[corner_point_grid,well_locs_locations,lac_x,lac_y,ihs_hor,ihs_vert] = geogrid(filename,loc_wells,nx,ny,nz,PBH,DTOP);
