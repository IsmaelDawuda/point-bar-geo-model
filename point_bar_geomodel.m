...
aa = 1:numel(filename(:,1));aa=aa'; b = num2str(aa); c = cellstr(b);
 dx = 40; dy =40; % displacement so the text does not overlay the data points, it can be adjusted depending on the data given
...
a = 1:numel(channel_x);a=a'; b = num2str(a); c = cellstr(b);
 dxx = 40; dyy =40; % displacement so the text does not overlay the data points, it can be adjusted depending on the data given
%text(channel_x+dx4, channel_y + dy4, c);
