...
rect_corner_grid = [XX YY DTOP+flipud(ZZ)];
rect_center_grid = [xcoord_center_rect(:) ycoord_center_rect(:) DTOP+flipud(zcoord_center_rect(:)) ];
curv_center_grid = [xcoord_center_curv(:) ycoord_center_curv(:) DTOP+flipud(zcoord_center_curv(:)) ];
