...
Download all data and run the 'point-bar-geomodel.m' using the "Demo.m" file
...
filename.txt    :       % the file containing the coordinates of the channel meander  path; the first and second columns are the x and y coordinates, respectively   
load loc_wells.txt;     % the file containing the coordinates of wells that may be present in the reservoir;  the first and second columns are the x and y coordinates, respectively
...
For this particular dataset example,  there are three concave parts; you may enter either 1, 2 or 3
...
For this particular dataset example,  you may enter any angle within a range of 30 to 40. 
